...
export const MAP_AREAS: readonly MapArea[] = [
  ...
  { id: 'wasserbehaelter-mauer', label: 'Wasserbehälter Mauer', category: 'wasser' },
  { id: 'baum-wassertank', label: 'Baum-Wassertank', category: 'wasser' },
  { id: 'tonne-geraeteschuppen', label: 'Regentonne (Geräteschuppen)', category: 'wasser' },
  { id: 'tonne-schuppen', label: 'Regentonne (Schuppen)', category: 'wasser' },
  { id: 'tonne-werkstatt', label: 'Regentonne (Werkstatt)', category: 'wasser' },
  { id: 'tonne-holzschuppen', label: 'Regentonne (Holzschuppen)', category: 'wasser' },
  { id: 'unterirdischer-wasserbehaelter', label: 'Unterirdischer Wasserbehälter', category: 'wasser' },
  // Technik
  { id: 'solaranlage', label: 'Solaranlage', category: 'technik' },
  { id: 'solaranlage-speicher', label: 'Solaranlage mit Speicher', category: 'technik' },
  // Natur
  ...
  { id: 'unterer-kompost', label: 'Unterer Kompost', category: 'natur' },
